<template>
    <div class="intro-y box p-5 mt-5">
        <div class="intro-y flex mb-4 p-1">
            <h2 class="text-xl font-medium mr-auto">Group Detail</h2>
            ...
            <router-link v-if="canUpdate" :to="{ name: 'GroupUpdate', params: { id: id }}">
        ...
        <div class="text-right mt-5">
            <router-link :to="{ name: 'GroupIndex'}" class="btn btn-primary w-24 mr-1" tag="button">Back</router-link>
        </div>
    </div>
</template>
