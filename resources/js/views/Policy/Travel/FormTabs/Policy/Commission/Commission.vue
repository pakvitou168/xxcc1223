...
export default {
    ...
    methods: {
        checkCommissionDataAvailability(){     
            this.isLoading= true;
            axios.get(`/travel/policies/policy-services/is-commission-data-available/${this.id}`)
                .then(response => {
                    if(response.data)
        ...
        generateCommissionData() {
            axios.get(`/travel/policies/policy-services/generate-commission-data/${this.id}`)
        ...
        getCommissionData() {
            if (this.id){
                this.isLoading = true
                axios.get(`/travel/policies/policy-services/get-commission-data/${this.id}`)
                    .then(response => {
        ...
        getBusinessNameByBusinessCode(businessCode) {
            axios.get(`/travel/policies/policy-services/get-business-name-by-business-code/${businessCode}`).then(response => {
