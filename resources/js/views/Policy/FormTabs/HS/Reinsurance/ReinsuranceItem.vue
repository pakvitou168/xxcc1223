...
import renewalDataService from "@/services/hs/renewal_data.service";
...
export default {
  ...
  methods: {
        ...
        renewalDataService
          ...
          .then((response) => {
            if (response.data.success) {
              notify(this.SUCCESS_MESSAGE, "success", "bottom-right");
              // Update issue_date
    ...
    handleIssueDate() {
      hsService.updateIssueDate(this.reinsurance[0].data_id).catch((e) => {
        console.log(e);
      });
    },
