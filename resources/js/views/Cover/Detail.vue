                    ...
                    <div>
                        <div>
                            <div class="intro-y flex mb-4 p-1">
                                <h2 class="text-xl font-medium mr-auto">Cover Details</h2>
                                ...
                                <router-link v-if="canUpdate" :to="{ name: 'CoverUpdate', params: { id: id }}">
                            ...
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Is Mandatory</span>
                                <svg v-if="covers.mandatory>0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-labelledby="check-circle" role="presentation" class="text-green-500 fill-current text-success">
                            ...
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Is Vehicle Value Required</span>
                                <svg v-if="covers.is_required_vehicle_val>0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-labelledby="check-circle" role="presentation" class="text-green-500 fill-current text-success">
                                    <path d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-2.3-8.7l1.3 1.29 3.3-3.3a1 1 0 0 1 1.4 1.42l-4 4a1 1 0 0 1-1.4 0l-2-2a1 1 0 0 1 1.4-1.42z"></path>'
                                </svg>
                                <svg v-else xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-labelledby="x-circle" role="presentation" class="text-red-500 fill-current text-danger">
                                    <path d="M4.93 19.07A10 10 0 1 1 19.07 4.93 10 10 0 0 1 4.93 19.07zm1.41-1.41A8 8 0 1 0 17.66 6.34 8 8 0 0 0 6.34 17.66zM13.41 12l1.42 1.41a1 1 0 1 1-1.42 1.42L12 13.4l-1.41 1.42a1 1 0 1 1-1.42-1.42L10.6 12l-1.42-1.41a1 1 0 1 1 1.42-1.42L12 10.6l1.41-1.42a1 1 0 1 1 1.42 1.42L13.4 12z"></path>
                            ...
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Detail (English)</span>
                                <p class="w-3/4 text-base text-bold intro-x" v-html="covers.html_detail"></p>
                            </div>
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Detail (Khmer)</span>
                                <p class="w-3/4 text-base text-bold intro-x" v-html="covers.html_detail_kh"></p>
                            </div>
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Detail (Chinese)</span>
                                <p class="w-3/4 text-base text-bold intro-x" v-html="covers.html_detail_zh"></p>
                            </div>
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Deductible Label (English)</span>
                                <p class="text-base text-bold intro-x" v-html="covers.deductible_label"></p>
                            </div>
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Deductible Label (Khmer)</span>
                                <p class="text-base text-bold intro-x" v-html="covers.deductible_label_kh"></p>
                            </div>
                            <hr>
                            <div class="flex m-2">
                                <span class="text-base w-1/4 intro-x">Deductible Label (Chinese)</span>
                                <p class="text-base text-bold intro-x" v-html="covers.deductible_label_zh"></p>
                            </div>
                            <hr>
                            <div class="text-right mt-5">
                                 <router-link to="/product-configuration/covers" class="btn btn-primary w-24 mr-1" tag="button">Back</router-link>
                            </div>
                        </div>
                    </div>
                </div>
