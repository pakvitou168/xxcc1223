<template>
    <div class="intro-y box p-5 mt-5">
        <div class="intro-y flex mb-4 p-1">
            <h2 class="text-xl font-medium mr-auto">Vehicle Usage Detail</h2>
            ...
            <router-link v-if="canUpdate" :to="{ name: 'VehicleUsageUpdate', params: { id: id }}" class="btn btn-primary mx-1 intro-x">
        ...
        <div class="text-right mt-5">
            <router-link :to="{ name: 'VehicleUsageIndex' }" class="btn btn-primary w-24 mr-1" tag="button">Back</router-link>
        </div>
    </div>
</template>
