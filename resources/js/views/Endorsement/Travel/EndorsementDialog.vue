...
export default {
  ...
  methods: {
    ...
    listEndorsementTypes() {
      axios.get('/travel/endorsements/list-endorsement-types').then((response) => {
    ...
    getValidEndorsementDatePeriod() {
      axios.get('/travel/endorsement-service/get-valid-endorsement-date-period/' + this.$route.params.id).then(res => {
