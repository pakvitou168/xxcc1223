...
<script>
import ReinsuranceItem from "../../../../Policy/FormTabs/HS/Reinsurance/ReinsuranceItem.vue";
import CommissionItem from "../../Commission/HS/CommissionItem.vue";
...
import HSReInsurance from "@/views/Policy/FormTabs/Info/HS/ReInsurance.vue"

export default {
  components: {
    ReinsuranceItem,
    CommissionItem: CommissionItem,
    HSReInsurance:HSReInsurance
  },
  props: {
    id: [Number, String],
    documentNo: String,
