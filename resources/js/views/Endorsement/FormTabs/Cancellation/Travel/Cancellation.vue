    ...
    <div v-else class="grid grid-cols-2 sm:grid-cols-1 gap-10">
      <FormulateForm v-model="formValues" @submit="handleSubmit">
        ...
        <div class="text-right">
          <router-link :to="{ name: 'TravelEndorsementIndex' }" class="btn btn-outline-secondary w-24 mr-1"
...
import travelService from "@/services/travel/policy/travel.service.js";
...
export default {
  ...
  methods: {
    ...
    handleIssueDate() {
      travelService.updateIssueDate(this.dataId).catch((e) => {
        console.log(e);
      });
    },
