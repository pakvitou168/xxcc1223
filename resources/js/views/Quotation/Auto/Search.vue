<template>
    <div>
        <div class="grid grid-cols-12 gap-3 pt-3">
            ...
            <div class="col-span-6 lg:col-span-3">
                <FloatLabel>
                    <Calendar id="issued_date_from" showIcon v-model="filterValues.issued_date_from" @update:modelValue="setFilter" :maxDate="filterValues.issued_date_to" />
                    <label for="">From Date</label>
                </FloatLabel>
            </div>
            <div class="col-span-6 lg:col-span-3">
                <FloatLabel>
                    <Calendar id="issued_date_to" showIcon v-model="filterValues.issued_date_to" @update:modelValue="setFilter" :minDate="filterValues.issued_date_from" />
                    <label for="">To Date</label>
                </FloatLabel>
            </div>
            <div class="col-span-6 lg:col-span-3">
                <button class="button-primary leading-6" @click="clearSearch">Clear</button>
            </div>
        </div>
    </div>
</template>
