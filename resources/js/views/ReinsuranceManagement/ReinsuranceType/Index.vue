  ...
  data() {
    return {
      ...
      addNew: {
        ...
        prefix: "Add New",
        linkAddNew: "/reinsurance-management/reinsurance-types/new",
      },
      tabulator: null,
      options: {
        persistenceID: "reinsurance-types-table",
        ajaxURL: "/reinsurance-types",
        columns: [
          {
            title: "Code",
            field: "code",
          ...
          },
          {
            ...
            cellClick: (e, cell) => {
              ...
              if (cell._cell.element.querySelector("a.edit svg").contains(e.target))
                this.$router.push("/reinsurance-management/reinsurance-types/" + dataId + "/edit");
              else if (cell._cell.element.querySelector("a.view svg").contains(e.target))
                this.$router.push("/reinsurance-management/reinsurance-types/" + dataId + "");
