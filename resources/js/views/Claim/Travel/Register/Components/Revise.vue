<template>
    <Dialog :visible="isVisible" :style="{ width: '340px' }" :modal="true" :closable="false" :header="header">
        ...
        <template #footer>
            <Button label="Cancel" class="btn btn-danger " type="button" @click="hideDialog" />
            <Button label="Confirm" class="btn btn-primary" :loading="submitted" autofocus type="button" @click="invokeSubmit" />
        </template>
    </Dialog>
</template>
