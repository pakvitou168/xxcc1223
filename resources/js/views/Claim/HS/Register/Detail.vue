      ...
      <div class="grid 2xl:grid-cols-3 px-5 sm:px-16 pb-10">
        <div class="col-span-2">
          <div class="pt-6">
            ...
            <div class="flex">
              <div class="w-1/3 text-right pr-5">
                <div class="text-base font-bold mb-1.5">Clinic</div>
              </div>
              <div class="w-2/3">
                <div class="text-base">: {{ formValues.clinic_name }}</div>
              </div>
            </div>
            <div class="flex">
              <div class="w-1/3 text-right pr-5">
              ...
              <div class="w-2/3">
                <div class="text-base">: {{ formValues.cause_of_loss }}</div>
              </div>
            </div>
            <div class="flex">
              <div class="w-1/3 text-right pr-5">
                <div class="text-base font-bold mb-1.5">Cause of Loss Disability</div>
              </div>
              <div class="w-2/3">
                <div class="text-base">: {{ formValues.cause_of_loss_disability }}</div>
              </div>
            </div>
            <div class="flex">
              <div class="w-1/3 text-right pr-5">
            ...
            <div class="flex">
              ...
              <div class="w-2/3">
                <div class="text-base">: {{ formValues.insurance_cover_period }}</div>
              </div>
            </div>
          </div>
          <div class="pt-6">
            <div class="text-xl font-bold mb-2.5">Claim Estimation: <span>{{ formatCurrency(formValues.reserve_amount)
                }}</span></div>
          </div>
          <div class="pt-6">
...
<!--    <ApproveDialog :isVisible="showDialog"
    ...
    <ApproveDialog
        ...
        :header="formValues.approved_status == null ? 'Register Approval' : 'Schema Data Approval'"
        :submitted="submitted"
...
import RegisterService from "@/services/claim/hs/claim_register.service";
...
export default {
  ...
  computed: {
    ...
    canApprove() {
      let canApprovePermission = hasPermission("HS_CLAIM_REGISTER", "APPROVE");
