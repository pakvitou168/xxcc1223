            ...
            <div class="intro-y box grid gap-y-2 mt-5 p-5">
                <div class="grid lg:grid-cols-2 gap-x-2 gap-y-2">
                    <div class="">
                      ...
                      />
                      <span v-if="errors.name" class="p-error block">
                        {{ errors.name[0] }}
                      </span>
                    </div>
                    <div class="">
                      ...
                      />
                      <span v-if="errors.type" class="p-error block">
                        {{ errors.type[0] }}
                      </span>
                    </div>
                    <div class="">
                      ...
                      />
                      <span v-if="errors.contact_name" class="p-error block">
                  ...
                  <div class="">
                      ...
                      />
                      <span v-if="errors.contact_number" class="p-error block">
                ...
                <div class="grid grid-cols-1">
                  ...
                  <span v-if="errors.address" class="p-error block">
                    {{ errors.address[0] }}
                  </span>
                </div>
            </div>
