...
@section('content')
    ...
    <body class="login">
        <form action="{{ route('security_auth') }}" method="POST">
            @csrf
                ...
                <div class="block xl:grid grid-cols-2 gap-4">
                    ...
                    <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                        <div
                            ...
                            @if (session('error'))
                            <div class="text-red-700 mx-1 mt-2 max-w-96 break-words" role="alert">
                                <strong>{{ session('error') }}</strong>
                            </div>
                            @endif
                            <div class="intro-x mt-8">
                                {{-- @if (\Session::get('url.intended'))
                                <p class="text-red-700 mx-1 first-letter:uppercase">{{__('please login to continue')}}!</p>
                                @endif --}}
                            ...
                            <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                                <div class="flex items-center mr-auto">
                                    ...
                                    <label class="cursor-pointer select-none" for="remember-me">Remember
                                        me</label>
                                </div>
