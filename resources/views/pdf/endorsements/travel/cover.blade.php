   ...
   <div class="pt-3">
      <div class="clearfix">
         ...
         <div class="w-2/3 inline-block float-right">
            <div class="font-bold mb-3">{{ $isEn ? @$travel->insured_name : @$travel->insured_name_kh }}</div>
         </div>
      </div>
      <div class="clearfix">
         <div class="w-1/3 inline-block float-left">
      ...
      <div class="clearfix">
         ...
         <div class="w-2/3 inline-block float-right">
            <div class="mb-3">
               {{ \Carbon\Carbon::parse(@$travel->endorsement_e_date)->format('d/F/Y') }}
            </div>
         </div>
      </div>
      ...
      <div class="clearfix">
         ...
         <div class="w-2/3 inline-block float-right">
            <div class="text-sm mb-3">{!! $travel->end_description !!}</div>
         </div>
      </div>
      ...
      <div class="clearfix">
         ...
         <div class="w-2/3 inline-block float-right">
            <div class="mb-3">{{ $travel->endorsement_premium >= 0 ? number_format($travel->endorsement_premium,2) : '('.number_format(abs($travel->endorsement_premium),2).')' }}</div>
         </div>
      </div>
