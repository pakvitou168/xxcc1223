    ...
    <div class="clearfix mb-1">
        <table class="w-full border border-black border-collapse font-size-table">
            ...
            <tr>
                ...
                @else
                @if($credit->total_premuim < 0) <td class="font-bold text-center">{{ '$ ('.number_format(abs($credit->total_premuim) , 2).')' }}</td>
                    @else
            ...
            <tr>
                ...
                <td class="text-center">-</td>
                @else
                @if($credit->total_premuim < 0) <td class="font-bold text-center">{{ '('. number_format(round(abs($credit->total_premuim) * $credit->exch_rate), 2) . ')' }} <span class='font-khmer-os'>រៀល</span></td>
                    @else
