    ...
    <body class="{{ App::isLocale('km') ? 'font-khmer-os' : 'font-candara' }} mb-0">
        <div class="text-center">
            <div class="pt-1">
                <div class="{{ App::isLocale('km') ? 'font-khmer-os-moul-light' : 'font-candara' }} font-size-title font-bold text-center uppercase">
                    ...
                    @endif
                    <div class="pt-2">{{__('Insurance Quotation') }}</div>
                </div>
            </div>
            <div class="flex flex-col py-2">
                <div class="text-right">
                    <div class="mt-1">{{__('Quotation No')}} : <span>{{ $auto->quotation ? $auto->quotation->document_no : '' }}</span></div>
                    ...
                    <tbody>
                        @foreach ($auto->vehicles as $item)
                            <tr>
                                ...
                                @if ($auto->has_passenger_tonnage)
                                    <td class="p-1 text-right">{{ $item->passenger_tonnage }}</td>
                                @else
        ...
        <div class="py-5">
            ...
            <!-- <div class="clearfix">
                ...
                <div class="w-2/3 inline-block float-right">
                    <div class="mb-3">{{__('30 days from the issuance date')}}</div>
                </div>
            </div> -->
            <div class="clearfix">
                <div class="w-1/3 inline-block float-left">
                ...
                <div class="clearfix">
                    <div class="w-1/3 inline-block float-left">
                        <div class="relative" style="min-height: 150px;">
                            @if(request('noStamp') && !$hasLetterHead && $signature && file_exists(public_path($signature->file_url)))
                                <img class="img-over" src="{{ public_path($signature->file_url) }}" style="max-height: 150px">
                            @elseif ($hasLetterHead && $signature && file_exists(public_path($signature->file_url)))
                                <img class="img-over" src="{{ public_path($signature->file_url) }}" style="max-height: 150px">
