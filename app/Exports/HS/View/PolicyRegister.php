...
class PolicyRegister implements FromView, ShouldAutoSize, WithStartRow, WithStyles,WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        $cloneQ = clone $data;
        $cloneQry = clone $data;
        $this->totalRecord = $cloneQ->count() + 9;
        $this->report = $cloneQry->get();
        $reportPeriod = $this->reportPeriod();
        return view("pdf.policies.hs.register", ['data' => $data, 'reportPeriod' => $reportPeriod, 'treaties' => $this->treaties]);
    }
